...
/*
  ...
  GOOGLE_SIGN_IN_START: 'user/GOOGLE_SING_IN_START',
...
export const emailSingInStart = (email, password) => createAction(USER_ACTION_TYPES.EMAIL_SIGN_IN_START, { email, password });
